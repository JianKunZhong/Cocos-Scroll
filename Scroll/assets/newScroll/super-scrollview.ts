...
export class SuperScrollview extends ScrollView {
    ...
    public onEnable() {
        super.onEnable()
        this.node.on(ScrollView.EventType.SCROLL_ENG_WITH_THRESHOLD, this.dispatchPageTurningEvent, this)
    }
    public onDisable() {
        super.onDisable()
        this.node.off(ScrollView.EventType.SCROLL_ENG_WITH_THRESHOLD, this.dispatchPageTurningEvent, this)
    }
    get layout() {
